...
& python (Join-Path $sdk 'tools/idf_tools.py') --non-interactive --idf-path $sdk install --targets=esp32,esp32c6,esp32c3,esp32s3
...
Write-Host 'ESP32: .\firmware\esp32\tools\probe.ps1 -Action build'
